...
class Usuario extends Db
{
...

					{
						...
						if($tipo_doc == '' ){return 'hay campos vacios';exit();}
						if($doc == '' ){return 'hay campos vacios';exit();}
						if($nom == '' ){return 'hay campos vacios';exit();}
						if($ape == '' ){return 'hay campos vacios';exit();}
						if($cel == '' ){return 'hay campos vacios';exit();}
						if($fij == '' ){return 'hay campos vacios';exit();}
						if($mail == '' ){return 'hay campos vacios';exit();}
						if($pais == '' ){return 'hay campos vacios';exit();}
						if($ciudad == '' ){return 'hay campos vacios';exit();}
						if($direccion == '' ){return 'hay campos vacios';exit();}
						$clave = $this->contra();
